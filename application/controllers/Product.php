...
class Product extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model("product_resim_model");
    ...
    public function imageDelete($id, $parent_id)
    {
        ...
        $fileName = $this->product_resim_model->get(
            array(
                "id" => $id
            )
        );

        $delete = $this->product_resim_model->delete(
            array(
                "id" => $id
            )
        );
    ...
    public function imageIsActiveSetter($id)
    {
        ...
        if ($id) {
            ...
            $this->product_resim_model->update(
                array(
                    "id" => $id
                ),
                array(
    ...
    public function isCoverSetter($id, $parent_id)
    {
        ...
        if ($id && $parent_id) {
            ...
            $viewData->item_images = $this->product_resim_model->get_all(
                array(
                    "product_id" => $parent_id
                ),
                "rank ASC"
