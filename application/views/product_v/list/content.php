        ...
        <div class="widget p-lg">
            ...
            if(empty($items)) {
                ...
                <div class="alert alert-info">
                    <p>Burada herhangi veri bulunmamaktadır. Eklemek için lütfen <a href="<?php echo base_url("product/new_form") ?>">tıklayınız</a></p>
                </div>
                <?php 
            } else {
                ?>
                        ...
                        foreach ($items as $item) {
                            ...
                            <tr id="ord-<?php  echo $item->id; ?>">
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url("product/update_form/$item->id"); ?>" class="btn btn-info btn-outline btn-sm"><i class="fa fa-pencil"></i> Düzenle</a>
                                    <a href="<?php echo base_url("product/image_form/$item->id"); ?>" class="btn btn-warning btn-outline btn-sm text-dark"><i class="fa fa-image"></i> Resimler</a>
                                </td>
                            </tr>
