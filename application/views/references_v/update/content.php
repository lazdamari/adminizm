    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form method="post" action="<?php echo base_url("references/update/$item->id"); ?>" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo base_url("references") ?>" class="btn btn-default">İptal</a>
                </form>
            </div>
        </div>
    </div>
