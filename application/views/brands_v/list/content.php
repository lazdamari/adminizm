<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Marka Listesi
            <a href="<?php echo base_url("brand/new_form") ?>" class="btn btn-success btn-sm pull-right"> <i
            ...
            if (empty($items)) {
                ...
                <div class="alert alert-info">
                    <p>Burada herhangi veri bulunmamaktadır. Eklemek için lütfen <a
                                href="<?php echo base_url("brand/new_form") ?>">tıklayınız</a></p>
                </div>
                <?php
            } else {
                ?>
                    ...
                    foreach ($items as $item) {
                        ...
                        <tr id="ord-<?php echo $item->id; ?>">
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url("brand/update_form/$item->id"); ?>"
